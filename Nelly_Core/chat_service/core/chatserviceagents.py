...
from core.transformer.transformer import TransformerGeneratorAgent


class ChatServiceAgent(TransformerGeneratorAgent, ABC):
    """
    ...
    def observe(self, act):
        ...
        """
        super(ChatServiceAgent, self).observe(act)
    ...
    def act(self):
        ...
        """
        return super(ChatServiceAgent, self).act()
