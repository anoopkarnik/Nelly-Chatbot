...
"""
Websocket Manager Module Contains implementation of the WebsocketManager which helps run Nelly
"""
import asyncio
import json
import logging
...
import chat_service.utils.logging as log_utils
import chat_service.utils.misc as utils
from chat_service.core.chat_service_manager import ChatServiceManager
from chat_service.websocket.websocketagents import WebsocketAgent
from chat_service.websocket.sockets import MessageSocketHandler
...
class WebsocketManager(ChatServiceManager):
    ...
    def parse_additional_args(self, opt):
        self.should_load_model = opt.get('load_model', True)
    ...
    def _make_app(self):
        ...
        print("starting tornado web app")
