...
from core.teachers import (
    ParlAIDialogTeacher,
    create_task_agent_from_taskname,
    MultiTaskTeacher,
)
from core.convai2.agents import (
    DefaultTeacher as Convai2DefaultTeacher,
    BothTeacher,
)
from core.empathetic_dialogues.agents import EmpatheticDialoguesTeacher
from core.wizard_of_wikipedia.agents import WizardDialogKnowledgeTeacher
