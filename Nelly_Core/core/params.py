...
def str2class(value):
    ...
    For example, the string 'agents.drqa.drqa:SimpleDictionaryAgent' returns
    <class 'agents.drqa.drqa.SimpleDictionaryAgent'>.
    """
    if ':' not in value:
...
class ParlaiParser(argparse.ArgumentParser):
    ...
    def __init__(
        ...
        self.parlai_home = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))
