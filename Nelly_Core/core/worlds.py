...
from core.metrics import aggregate_named_reports
from core.opt import Opt
from core.teachers import Teacher, create_task_agent_from_taskname
from utils.misc import Timer, display_messages
from core.tasks import ids_to_tasks
...
class DialogPartnerWorld(World):
    ...
    def report(self):
        ...
        """
        from core.metrics import Metric, LegacyMetric
...
def _create_task_agents(opt: Opt):
    ...
    It does this by calling the create_agent function in chatserviceagents.py of the given task. If
    ...
    try:
        # Tries to call the create_agent function in chatserviceagents.py
