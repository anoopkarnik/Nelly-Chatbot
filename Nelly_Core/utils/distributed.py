...
def is_distributed():
    ...
    """
    logging.info("Is torch available : " + str(TORCH_AVAILABLE))
    logging.info("Is Dist available : " + str(dist.is_available()))
    logging.info("Is Dist Initialized available : " + str(dist.is_initialized()))
...
def num_workers():
    ...
    if not is_distributed():
        ...
        logging.info("is distributed and world size : " + dist.get_world_size())
