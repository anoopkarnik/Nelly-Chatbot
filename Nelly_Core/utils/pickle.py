...
>>> import utils.pickle
>>> state_dict = torch.load(filename, pickle_module=core.utils.pickle)
"""
    ...
    def find_class(self, module, name):
        try:
            ...
            if module.startswith('apex.'):
                ...
                if (
                    module == 'parlai.core.utils' or module == 'core.utils.misc'
                ) and name == 'Opt':
                    from core.opt import Opt

                    return Opt
                if module == 'parlai.core.dict' and name == '_BPEHelper':
                    from utils.bpe import SubwordBPEHelper as _BPEHelper
